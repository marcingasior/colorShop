...
const assert = require("assert"),
    colorService = require('../lib/service').ColorService;

describe("colorService test", () => {
const customers = colorService.normalizeCustomers(require('../data/simple-data.json'));
    ...
    describe("normalize customers", () => {
      it("should return normalized array of customers", () =>{
          let res = colorService.normalizeCustomers({"customers": [[{id:1, type: "G"}]]});
